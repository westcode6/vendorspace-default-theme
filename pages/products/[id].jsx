      ...
      <main className="grid grid-cols-1 md:grid-cols-2 px-1 md:px-16 my-5">
        ...
        <div className="flex flex-col px-3 md:px-16 mt-7 md:mt-0">
          ...
          <div className="flex px-2 md:px-5">
            <div class="relative">
              <div class="text-center left-4 pt-2  absolute block text-xs uppercase text-gray-600 tracking-wide font-semibold">
                Qty
              </div>
              <select class="cursor-pointer appearance-none text-sm rounded-xl bg-white border border-gray-200 pl-4 pr-10 h-14 flex items-end pb-1">
                <option>1</option>
                <option>2</option>
                <option>3</option>
              </select>
              ...
              <svg
                class="w-5 h-5 text-gray-400 absolute left-9 bottom-0 mb-1 mr-2"
          ...
          <div className="my-7 flex px-2 md:px-5">
            <h2 className="text-lg text-gray-700 font-semibold">Share</h2>
          ...
          <div className="bg-white shadow px-2 md:px-5">
            <header className="">
              ...
              <p className="py-4 text-sm text-gray-500">
                ...
                consequuntur laborum consequatur corporis culpa ratione.
                Veritatis quis sed molestias nobis. Lorem ipsum dolor sit amet
                consectetur, adipisicing elit. Voluptas ea vero ab excepturi,
                vitae soluta! Lorem ipsum dolor sit amet consectetur. Lorem
